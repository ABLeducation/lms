...
urlpatterns = [
    ...
    path('mentor_training_level/',views.mentor_training_level, name="mentor_training_level"),
    path('mentor_trainer_subject_1/',views.mentor_subject_1, name="mentor_trainer_subject_1"),
    path('mentor_trainer_subject_2/',views.mentor_subject_2, name="mentor_trainer_subject_2"),
    path('mentor_trainer_subject_3/',views.mentor_subject_3, name="mentor_trainer_subject_3"),
    path('mentor_lesson/<slug:slug>',views.mentor_lesson,name="mentor_lesson"),
    path("mentor_lesson_detail/<slug:slug>",views.mentor_lesson_detail, name="mentor_lesson_detail"),
    path('rate-lecture/', views.LectureRatingCreateView.as_view(), name='rate-lecture'),
    ...
    # path("mechanzo_kits/", views.display_kits, name="mechanzo_kits"),
